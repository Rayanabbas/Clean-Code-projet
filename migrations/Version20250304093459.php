 ...
 */
final class Version20250304093459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, borrowed_books CLOB NOT NULL --(DC2Type:array)
        )');
